...
class SpeechDataset(Dataset):
    def __init__(self, noise_type):
        ...
        self.noise_file_path = (
            "/Users/rockwell/Documents/python/SE-with-SubSampler/data/source/urban/0_air_conditioner/13230-0-0-1.wav"
        )
        self.clean_file_path = "/Users/rockwell/Documents/python/SE-with-SubSampler/data/source/clean/p226_001.wav"
        self.snr_level = 5
        self.max_len = 32704
        self.sr = 16000
        self.batch_size = 1
